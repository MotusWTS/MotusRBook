...
file.name <- "./data/project-8.motus"    ## replace with the full location of your project data
...
5. tagDeps: metadata related to tag deployments, e.g., deployment date, location, and species.
...
10. gps: metadata related to Geographic Positioning System (GPS) position of receiver. 
...
The below example is how you would save the flat file called "df.flat" within R, as a .csv file called "motus_detecitons.csv" on your computer in the 'data' folder of your working directory.

```{r createFlat, message = FALSE, warning = FALSE}

write.csv(df.flat, "./data/df_raw.csv")  ## "df.flat"" is the name of the flat file within R that you want to convert to a .csv
