...
Your project's .motus file is available for download at <www.motus.org/data/downloads> under your project profile. Once downloaded, **make sure that you have the appropriate packages installed and loaded in R as outlined in Chapter 2-LoadingPackage**. Once packages are loaded, you can import your tag detections into R using the following code:
...
write.csv(df.flat, "C:/data/motus_detections.csv")  ## "df.flat"" is the name of the flat file within R that you want to convert to a .csv; "C:/data/" is the the location where you would like your .csv stored; "motus_detections.csv", is the name of the .csv file you are creating, this can be anything you like but must end with .csv.
