...
proj.num <- 123 ## use the number associated with your project here
...
t <- tagme(projRecv = proj.num) ## if the file is in the local working directory, OR:
t <- tagme(projRecv = proj.num, dir = "./data/") ## use dir = to specify a directory
...
vt.1 <- tbl(t, "alltagswithambigs") ## virtual table
vt.2 <- tbl(t, "alltags")
```
