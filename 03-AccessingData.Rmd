...
```{r fig3}
knitr::include_graphics("F:/Motus/Motus_RPackage/pics/DataStructure.png")
```
...
Your project's .motus file is available for download at <www.motus.org> under your project profile. Once downloaded, you can import your tag detections into R using the following code:
