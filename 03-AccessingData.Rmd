...
And you can run the function and save all output by setting the 'out.dir' and 'in.df' parameters and running the following:
...
# and run the function, which will output an .rds file for each table in the specified directory
