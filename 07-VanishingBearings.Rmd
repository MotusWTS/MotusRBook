...
```{r vanishFig1, echo=FALSE, fig.align='center', out.width = "60%"}
...
```{r vanishFig2, echo=FALSE, fig.align='center', out.width = "60%"}
...
```{r vanishFig3, echo=FALSE, fig.align='center', out.width = "60%"}
...
```{r vansihFig4, echo=FALSE, fig.align='center', out.width = "60%"}
...
```{r vanishFig5, echo=FALSE, fig.align='center', out.width = "60%"}
