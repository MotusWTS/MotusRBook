...
# Oct 16, 2018: due to recent updates, the development version of ggmap must be used.
# Ensure that packages are updated prior to installing 
# (see https://groups.google.com/forum/#!topic/motus-wts/UxqFIO6Pcmo and https://github.com/dkahle/ggmap/issues/51)
