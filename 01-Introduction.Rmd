...
The sample .motus dataset can be accessed through the motusdata R package, for information on installing and loading the package see chapter \@ref(loadingPackages):

```{r importSampleDF, message = FALSE, warning = FALSE}
