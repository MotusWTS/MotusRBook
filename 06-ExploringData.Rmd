...
**Important Note** As of October 16, 2018 recent updates require the use of a Google key to access google maps. To obtain an access key, you must be a registered Google user with **up to date billing information**, however you do not have to pay for the service. To obtain a key, login to the [Google Cloud Platform](https://cloud.google.com/console/google/maps-apis/overview), and under teh navigation menu click APIs & Services > Credentials, then click Create credentials > API key full details are listed under ["Detailed guide"](https://developers.google.com/maps/documentation/javascript/get-api-key)
See(ENTER THE GOOGLE FEED YOLANDA POSTED)
