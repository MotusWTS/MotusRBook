...
Or, if you imported the RDS and are using a flat dataframe:

```{r importData3, eval = FALSE}
...
Doing the same summary with the RDS dataframe:

```{r summaryAllTags, eval = FALSE}
