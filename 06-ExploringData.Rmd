...
# IMPORTANT! If you don't want to save your personal key in the RBook, just make sure to run register_google(key = "Your key") prior to building book, or you can save it here:
ggmap::register_google(key = "AIzaSyBmWa9vDRHHqQHtbINekS2S7OIOb7e79mk")
