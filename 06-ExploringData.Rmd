...
library(motus)
library(tidyverse)
# Oct 16, 2018: Note that the developers version must be used as described in Chapter 2
library(ggmap)
...
**Important Note** As of October 16, 2018 recent updates require the use of a Google key to access google maps. To obtain an access key, you must be a registered Google user with up to date payment details (you do not have to pay for the service however). To obtain a key...
