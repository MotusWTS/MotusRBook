...
(src, filterName, motusProjID=NA, descr = NA) 
-	verify if the filterName already exists locally (for the current user and/or project). Create a new record if not.
-	returns the filterID (integer) matching the new filter in the local database
