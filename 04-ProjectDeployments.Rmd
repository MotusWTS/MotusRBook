...
This chapter is a compliment to the online "message center", which provides each project with a list of metadata issues (missing or outlying values) to be accepted or ignored, and is meant to help uncover any errors that might be missed by the automatic queries of the message center.
