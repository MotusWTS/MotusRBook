...
There are `r nrow(df.projRecvs)` receiver deployments registered to the sample project. Three deployments are missing latitude and longitude, which should be added to the metatdata on the motus site, and two deployments are missing end dates, which suggests that those two receivers are still deployed. 
...
df.projRecvs %>%
  ...
  arrange(deviceID, latitude, date)
