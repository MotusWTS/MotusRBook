...
```{r loadMapsRecv1, message = FALSE, warning = FALSE, echo = FALSE}
...
# Others countries in the Americas that you may want to plot, 
# depending on your location: "Mexico", "lakes","Belize", 
# "Costa Rica", "Panama", "Guatemala", "Honduras", "Nicaragua", 
# "El Salvador", "Colombia", "Venezuela", "Ecuador", "Peru", 
# "Brazil", "Guyana","Suriname", "Bolivia", "French Guiana", 
# "Jamaica", "Cuba", "Haiti", "Dominican Republic", "The Bahamas", 
# "Turks and Caicos Islands", "Puerto Rico", "British Virgin Islands", 
# "Montserrat", "Dominica", "Saint Lucia", "Barbados", "Grenada", 
# "Trinidad and Tobago", "Chile", "Argentina", "Uruguay"

```

```{r loadMapsRecv1DUP, eval = FALSE}
