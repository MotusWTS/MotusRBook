...
The number of rows in the 'df.tags' database is equivalent to the number of tags registered to the James Bay Shorebird Project. There are `r nrow(df.tags)` tags registered to the project (recall we are using just a subset of this large dataset):
