...
1. downlaod full tag metadata for our project only;  
2. determine how many tags are registered to your project;  
3. determin how many of those registered tags were deployed;  
4. determine location of tag deployments;  
5. determin completeness and accuracy of tag deployment metadata.  
...
1. downlaod full receiver metadata across the network;  
2. determin number of project receiver deployments;
3. determin timing of project receiver deployments;
4. determin location of network-wide and project receiver deployments;
5. determin completeness and accuracy of receiver metadata.
