...
Although some of these may be valid detections, we have found it simpler to just remove them from our analysis, and possibly revisit them at a later stage. Therefore we filter on runLen (> 2) for most  subsequent operations.
