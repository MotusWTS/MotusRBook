...
df.alltags <- tbl.alltags %>% 
  ...
  mutate(ts = as_datetime(ts), # work with dates AFTER transforming to flat file
         ...
         recvDeployName = if_else(is.na(recvDeployName), paste(recvLat, recvLon, sep=":"), recvDeployName))
...
**motusTagIDs 22778, 22902 and 22403:**
