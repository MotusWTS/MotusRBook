...
As a first step, always ensure you are using the latest version of the motus package (see chapter \@ref(checkVersion)), and you have all required packages installed, and loaded, and up to date (see Chapter \@ref(loadingPackages).  
