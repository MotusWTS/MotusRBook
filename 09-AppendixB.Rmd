...
**ts** column for a date/time object as numeric or POSIXct, defaults to ts
**recvDepName**
**fullID**
**mfgID**
...
## simSiteDet
### Description
Creates a dataframe consisting of only detections of tags that are detected at two or more receivers at the same time.
### Dependencies
**data**
**ts**
**motusTagID**
...
### Example
To get a data.frame called "simSites" of just simultaneous detections from a dataframe df.alltags
